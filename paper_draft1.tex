...
\noindent Initially the when a cell is flagged for refinement is is subdivided statically into 4 equal parts for  the fine grid and there is no recursion in the region.
